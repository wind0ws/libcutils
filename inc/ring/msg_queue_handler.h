 ...
 * 
 * @param queue_msg_t  pointer to popped msg. do not freed this msg memory.
...
/**
 * create msg_queue_handler
 * 
 * @param queue_buf_size    total size of memory to hold msg
 ...
 * @param msg_p     msg ptr, will copy it's memory to queue
 ...
 * 
 * @param handler   pointer of queue handler pointer
 */
