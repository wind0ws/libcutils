...
extern "C" {
	...
	/**
	 * get current stringbuilder's string. 
	 * copy it if you bring returned string to other place.
	 * this function has no effect on internal data structure, 
	 * therefore you can continuous append string on stringbuilder.
	 * 
	 * WARN: DO NOT FREE OR MODIFY DATA on the return pointer. 
	 *       this pointer point to internal buffer.
	 */
