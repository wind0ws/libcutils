 ...
 * @return msg amount
 */
uint32_t fixed_msg_queue_available_pop_msg_amount(__in fixed_msg_queue msg_queue);
 ...
 * @return msg amount
 */
uint32_t fixed_msg_queue_available_push_msg_amount(__in fixed_msg_queue msg_queue);
