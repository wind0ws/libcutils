...
#define CONSOLE_LOG_NO_NEW_LINE_HELPER(level, fmt, ...) do{if(level >= xlog_config_level) { CONSOLE_LOG_CONFIG_METHOD(fmt, __VA_ARGS__); }}while(0);
...
#define CONSOLE_TLOGD(tag, fmt, ...)  CONSOLE_LOG_NO_NEW_LINE(LOG_LEVEL_VERBOSE,"[%lld][D][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT,time_stamp_current(), tag, __VA_ARGS__)
#define CONSOLE_TLOGI(tag, fmt, ...)  CONSOLE_LOG_NO_NEW_LINE(LOG_LEVEL_VERBOSE,"[%lld][I][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT,time_stamp_current(), tag, __VA_ARGS__)
#define CONSOLE_TLOGW(tag, fmt, ...)  CONSOLE_LOG_NO_NEW_LINE(LOG_LEVEL_VERBOSE,"[%lld][W][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT,time_stamp_current(), tag, __VA_ARGS__)
#define CONSOLE_TLOGE(tag, fmt, ...)  CONSOLE_LOG_NO_NEW_LINE(LOG_LEVEL_VERBOSE,"[%lld][E][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT,time_stamp_current(), tag, __VA_ARGS__)
...
#define CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT "\n"
#define CONSOLE_LOGV_NO_NEW_LINE(...) if(LOG_LEVEL_VERBOSE >= xlog_config_level ) { CONSOLE_LOG_CONFIG_METHOD(__VA_ARGS__); }
#define CONSOLE_LOGD_NO_NEW_LINE(...) if(LOG_LEVEL_DEBUG >= xlog_config_level) { CONSOLE_LOG_CONFIG_METHOD(__VA_ARGS__); }
#define CONSOLE_LOGI_NO_NEW_LINE(...) if(LOG_LEVEL_INFO >= xlog_config_level) { CONSOLE_LOG_CONFIG_METHOD(__VA_ARGS__); }
#define CONSOLE_LOGW_NO_NEW_LINE(...) if(LOG_LEVEL_WARN >= xlog_config_level) { CONSOLE_LOG_CONFIG_METHOD(__VA_ARGS__); }
#define CONSOLE_LOGE_NO_NEW_LINE(...) if(LOG_LEVEL_ERROR >= xlog_config_level) { CONSOLE_LOG_CONFIG_METHOD(__VA_ARGS__); }

#define CONSOLE_TLOGV(tag, fmt, ...)  CONSOLE_LOGV_NO_NEW_LINE("[%lld][V][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT, time_stamp_current(), tag, ##__VA_ARGS__)
#define CONSOLE_TLOGD(tag, fmt, ...)  CONSOLE_LOGV_NO_NEW_LINE("[%lld][D][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT, time_stamp_current(), tag, ##__VA_ARGS__)
#define CONSOLE_TLOGI(tag, fmt, ...)  CONSOLE_LOGV_NO_NEW_LINE("[%lld][I][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT, time_stamp_current(), tag, ##__VA_ARGS__)
#define CONSOLE_TLOGW(tag, fmt, ...)  CONSOLE_LOGV_NO_NEW_LINE("[%lld][W][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT, time_stamp_current(), tag, ##__VA_ARGS__)
#define CONSOLE_TLOGE(tag, fmt, ...)  CONSOLE_LOGV_NO_NEW_LINE("[%lld][E][%s] " fmt CONSOLE_LOG_CONFIG_NEW_LINE_FORMAT, time_stamp_current(), tag, ##__VA_ARGS__)
...
#define A_TLOGV(TAG, fmt, ...) if(LOG_LEVEL_VERBOSE >= xlog_config_level) {\
        __android_log_print(ANDROID_LOG_VERBOSE, TAG, fmt, ##__VA_ARGS__);\
    }
#define A_TLOGD(TAG, fmt, ...) if(LOG_LEVEL_DEBUG >= xlog_config_level) {\
        __android_log_print(ANDROID_LOG_DEBUG, TAG, fmt, ##__VA_ARGS__);\
    }
#define A_TLOGI(TAG, fmt, ...) if(LOG_LEVEL_INFO >= xlog_config_level) {\
        __android_log_print(ANDROID_LOG_INFO, TAG, fmt, ##__VA_ARGS__);\
    }
#define A_TLOGW(TAG, fmt, ...) if(LOG_LEVEL_WARN >= xlog_config_level) {\
        __android_log_print(ANDROID_LOG_WARN, TAG, fmt, ##__VA_ARGS__);\
    }
#define A_TLOGE(TAG, fmt, ...) if(LOG_LEVEL_ERROR >= xlog_config_level) {\
